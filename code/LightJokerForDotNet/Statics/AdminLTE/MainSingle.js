...
var signalEvent = {
    RealTime: function (json) { alert(json); }
};
...
$(function () {
    ...
    // 加载用户名
    $('.TitleUserName').text(sessionStorage.getItem(SESSION.USERNAME));
    ...
    // 初始化tabs控件
    arg_Obj_nthTabs = $("#main-nth-tabs").nthTabs({
        tabContentId: '#main-nth-tabs-content'
    });

    //刷新按钮
    $('#pageRefresh').click(function () {
        var _iframe = $('#main-nth-tabs-content').find('.tab-pane.active iframe');
