; (function ($) {
    ...
    var mould = function(selector){

        // 直接返回实例, 这里的 init 是真正的构造函数
        return new mould.fn.init(selector);
    }

    mould.fn = mould.prototype = {
        constructor: mould,
        version: 'v1.0.0',
    ...
    mould.fn.init.prototype = mould.fn;

    // 实现两种扩展
    mould.extend = mould.fn.extend = function(options){
